...
$(builddir)/randomization.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/randomization.node: LIBS := $(LIBS)
$(builddir)/randomization.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/randomization.node: TOOLSET := $(TOOLSET)
$(builddir)/randomization.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/randomization.node
# Add target alias
.PHONY: randomization
randomization: $(builddir)/randomization.node

# Short alias for building this executable.
.PHONY: randomization.node
randomization.node: $(builddir)/randomization.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/randomization.node
